...
instr_func opcode_entry[256] = {
    ...
    /* 0x50 - 0x53*/ push_r_v, inv, inv, push_r_v,
    ...
    /* 0xc8 - 0xcb*/ inv, _ref_leave, inv, inv,
    ...
    /* 0xe8 - 0xeb*/ call_i_near, jmp_near, inv, jmp_short,
...
instr_func group_1_bv_entry[8] =
    {add_i2rm_b, inv, inv, inv, inv, sub_i2rm_b, inv, cmp_i2rm_bv};
...
instr_func group_3_v_entry[8] =
    {inv, inv, inv, inv, inv, inv, inv, idiv_rm2a_v};

/* 0xff */
instr_func group_5_indirect_entry[8] =
    {inc_rm_w, inv, inv, inv, inv, inv, inc_rm_v, inv};
